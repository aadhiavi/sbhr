        ...
        <div className='heading-additions'><h1 data-aos="fade-up">What We Do</h1></div>
            <div className="video">
                <div className="vd">
                    ...
                    <h3 data-aos="fade-up">We create unforgettable experiences</h3>
                </div>
                <div className="vd">
                    <video src={vdo2} muted autoPlay loop />
                    <h3 data-aos="fade-up">Stay relaxed and comfortable</h3>
                </div>
                <div className="vd">
                    <video src={vdo3} muted autoPlay loop />
                    <h3 data-aos="fade-up">Celebrate with made-to-order menus</h3>
                </div>
                <div className="vd">
                    <video src={vdo4} muted autoPlay loop />
                    <h3 data-aos="fade-up">Where are we ?...closer than you think</h3>
                </div>
            </div>
    </div>
  )
